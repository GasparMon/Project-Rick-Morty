...
export default function Form(props) {
  ...
  return (
    <div id="div-principal">
      <img id="title-form" src="/img/name_form.png" alt="rick_morty_title"/>
      <img id="img-form" src="/img/rick_lading.jpeg" alt="rick_landing"/>
      <div id="form-div">
        <h1>Welcome to my Rick & Morty Project</h1>
      {/* <form id="form" onSubmit={handleSubmit}> */}
        ...
        <div class="div-label">
        {/* <button id="boton-form" disabled={errors.mail || errors.password} type="submit">Login</button> */}
        <button id="boton-form" type="submit" onClick={handleSubmit}>Login</button>
        </div>
      {/* </form> */}
      </div>
    </div>
